...
import static homework.packageBook.util.DateUtil.stringToDate;
...
public class StudentDemo implements Commands {
    ...
    public static void main(String[] args) {
        Lesson java = new Lesson("java", "teacher name 1", 33, 55,stringToDate("03/05/2021"));
        lessonStorage.add(java);
        Lesson javaScript = new Lesson("java script", "teacher name 2", 33, 55,stringToDate("02/07/2021"));
        lessonStorage.add(javaScript);
        Lesson mysql = new Lesson("mysql", "teacher name 3", 33, 55,stringToDate("02/04/2022"));
        lessonStorage.add(mysql);

        User admin = (new User("admin", "admin", "admin@mail.com", "admin", Role.ADMIN));
        userStorage.add(admin);

        studentStorage.add(new Student("Poxos", "Poxosyan", 13, "1234567", "Gyumri", java, admin,new Date()));
        studentStorage.add(new Student("Petros", "Poxosyan", 13, "1234567", "Gyumri", mysql, admin,new Date()));
        studentStorage.add(new Student("Martiros", "Poxosyan", 13, "1234567", "Gyumri", javaScript, admin,new Date()));
